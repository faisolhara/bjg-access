                        ...
                        <div class="row">
                            <form class="form-horizontal" role="form" action="{{ url('/absence') }}" method="POST">
                                ...
                                <div class="form-group">
                                    <label class="col-xs-4 control-label">Operating Unit</label>
                                    <div class="col-xs-8">
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="operatingUnit" id="operatingUnit" value="{{ !empty($filters['operatingUnit']) ? $filters['operatingUnit'] : '' }}" readonly>
                                            <span class="input-group-addon bg-custom b-0"><i class="mdi mdi-search text-white"></i></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
