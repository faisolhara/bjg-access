...
@section('title', 'Onhand Quantity 1')
        ...
        <div class="container">
            ...
            <div class="row">
				<div class="col-sm-12">
					<div class="card-box">
						<div class="row">
							<form class="form-horizontal" role="form" action="{{ url('/onhand') }}" method="POST">
	                    		{{ csrf_field() }}
								...
								<div class="table-responsive" data-pattern="priority-columns">
									<table id="tech-companies-1" class="table  table-striped table-hover table-bordered">
										<thead>
											<tr>
												<th>Action</th>
												<th data-priority="1">Org. Name</th>
												<th data-priority="1">Item Code</th>
												<th data-priority="1">Item Desc</th>
